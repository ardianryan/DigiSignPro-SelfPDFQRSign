...
<div class="max-w-6xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-8" x-data="bulkSignApp()">
        ...
        <div x-show="!zipLoaded">
            <div class="text-center py-10 border-2 border-dashed border-slate-300 rounded-xl hover:border-blue-500 transition-colors bg-slate-50 mb-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-start mt-2">
                                ...
                                <div class="ml-3 text-sm">
                                    ...
                                    <p class="text-slate-500 text-xs">Menampilkan ID TTE, Nama, dan Jabatan di bawah QR Code.</p>
                                </div>
                            </div>
                ...
                <div class="lg:col-span-2 order-1 lg:order-2">
                    ...
                    <div class="relative overflow-hidden border border-slate-300 bg-slate-500 flex justify-center" id="pdf-container">
                        ...
                        <!-- Draggable QR Marker -->
                        <div id="qr-marker" 
                             class="absolute w-24 h-24 bg-white/80 border-2 border-blue-600 flex items-center justify-center cursor-move shadow-xl backdrop-blur-sm z-10"
                             style="top: 50px; left: 50px;"
                             @mousedown="startDrag($event)"
                             @touchstart="startDrag($event)">
                            <div class="text-center">
                                <svg class="w-8 h-8 mx-auto text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v1m6 11h2m-6 0h-2v4h-4v-2h-2v4h6v-2h2v-2h2v-2h-2v2zM12 2h2v2h-2V2zm4 4v2h2V6h-2zm-4 4v2h2v-2h-2zm-4 2v2h2v-2H8zm-4 2v2h2v-2H4zm14 0v2h2v-2h-2zm4 4v2h2v-2h-2zm-4 0v2h2v-2h-2zm-4 0v2h2v-2h-2z"></path></svg>
                                <span class="text-[10px] font-bold text-blue-700">QR SIGN</span>
                            </div>
                        </div>
                    </div>
                </div>
