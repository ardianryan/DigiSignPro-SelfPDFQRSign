...
try {
    ...
    $outputPath = 'uploads/signatures/' . $filename;
    $fullOutputPath = __DIR__ . '/../../public/' . $outputPath;
    
    // Apply PDF Protection (Mandatory)
    $pdf_pass = $_POST['pdf_password'] ?? '';
    
    if (empty($pdf_pass)) {
        throw new Exception("Password Parafrase wajib diisi untuk keamanan dokumen.");
    }
