...
if ($action === 'install') {
    ...
    $conn->query("INSERT IGNORE INTO app_settings (id, app_name, maintenance_mode, registration_open, max_upload_size, max_upload_size_bulk, max_prefix_length) VALUES (1, 'DigiSign Pro', 0, 1, 10485760, 52428800, 3)");
    ...
    // 4. Create Lock File & Version File
