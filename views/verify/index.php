    ...
    <div class="max-w-md w-full bg-white rounded-xl shadow-lg overflow-hidden border-t-4 <?php echo $isValid ? 'border-green-500' : 'border-red-500'; ?>">
        ...
        <?php if ($isValid && $data): ?>
            ...
            <div class="p-6 space-y-5">
                ...
                if(!empty($filePath)): 
                    $fileUrl = Storage::getFileUrl($conn, $filePath);
                ?>
                <div class="mt-6 pt-4 border-t border-slate-100">
                    <a href="<?php echo $fileUrl; ?>" target="_blank" class="flex items-center justify-center w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-lg transition-colors shadow-md hover:shadow-lg">
